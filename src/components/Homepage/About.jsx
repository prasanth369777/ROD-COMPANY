...
export default function About() {
  ...
  const industrialValues = useMemo(() => [
    ...
    },
    {
      ...
      accent: "from-red-600 to-blue-400"
    },
    {
      ...
      accent: "from-blue-400 to-yellow-500"
    },
    {
      ...
      accent: "from-yellow-500 to-blue-500"
    },
  ], []);
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20 md:mb-32">
          ...
          <div className="relative order-2 lg:order-1 will-change-transform">
            <div className="absolute -left-4 md:-left-6 top-1/2 -translate-y-1/2 w-12 md:w-16 h-[80%] bg-blue-600/10 hidden lg:block -z-10"></div>
            <div className="relative bg-gray-100 p-2 shadow-2xl">
                ...
                />
                <div className="absolute top-6 md:top-10 right-0 lg:-right-10 bg-blue-600 p-4 md:p-8 text-white max-w-[200px] md:max-w-xs shadow-xl">
                    ...
                    <div className="absolute -bottom-6 -left-4 md:-bottom-8 md:-left-8 text-blue-600 font-['Caveat'] text-xl md:text-3xl -rotate-6 whitespace-nowrap bg-white px-2 py-1 shadow-sm">
          ...
          <div className="flex flex-col items-start order-1 lg:order-2">
            <div className="flex items-baseline gap-2 mb-4">
                <span className="text-6xl md:text-7xl lg:text-8xl font-bold text-slate-900 leading-none">25</span>
                <div className="flex flex-col">
                    <span className="text-xl md:text-2xl lg:text-4xl font-bold text-blue-600 leading-none">Years</span>
                    <span className="text-xl md:text-2xl lg:text-4xl font-light italic text-slate-400">Experience</span>
                </div>
            </div>
            
            <p className="text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] md:tracking-[0.3em] text-slate-400 mb-6 md:mb-8 border-b-2 border-blue-500 pb-2">
            ...
            <p className="text-base md:text-lg lg:text-xl text-slate-600 italic font-medium leading-relaxed mb-6 md:mb-8 relative">
                ...
                <svg className="absolute -bottom-2 left-0 w-32 md:w-48 text-blue-500/40" viewBox="0 0 100 10" preserveAspectRatio="none">
            ...
            <p className="text-slate-500 text-sm leading-relaxed mb-8 md:mb-10 max-w-xl">
                Whether you are a <span className="text-slate-900 font-bold">Contractor</span> on a large infrastructure project, a <span className="text-slate-900 font-bold">Quarry Owner</span>, or a repair shop looking for <span className="text-slate-900 font-bold relative">Authentic Spares 
                  <svg className="absolute -top-1 -left-1 w-full h-full text-blue-500/20 pointer-events-none" viewBox="0 0 100 100" preserveAspectRatio="none">
            ...
            <button 
                ...
                className="w-full md:w-auto inline-flex items-center justify-center gap-4 bg-blue-600 text-white px-8 md:px-10 py-4 md:py-5 font-bold uppercase text-xs tracking-widest hover:bg-slate-900 transition-all shadow-lg active:scale-95 transform-gpu"
            >
                Read More
            </button>
          </div>
        ...
        <div className="border-y border-gray-100 py-12 md:py-20 mb-20 md:mb-32 grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center relative">
            <div className="absolute -top-6 left-4 font-['Caveat'] text-blue-400 text-2xl md:text-3xl rotate-3">
              The Hub of Spares ↓
            </div>
            ...
            <div className="lg:col-span-8">
                <h2 className="text-2xl md:text-3xl lg:text-5xl font-bold uppercase tracking-tighter italic mb-4 md:mb-6 text-slate-900">
                    Trusted <span className="text-blue-600">Jackhammer</span> <br /> Spare Parts Distributor
                </h2>
            ...
            <div className="lg:col-span-4 flex justify-start lg:justify-end">
                <button 
                    onClick={() => navigate('/aboutus')}
                    className="w-full md:w-auto px-10 md:px-12 py-4 md:py-5 border-2 border-blue-600 text-blue-600 font-bold uppercase text-xs tracking-widest hover:bg-blue-600 hover:text-white transition-all transform-gpu"
                >
                    View Catalog
                </button>
            </div>
        ...
        <div className="mb-24 md:mb-40">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-16 gap-6">
                <h2 className="text-3xl md:text-4xl font-bold uppercase italic tracking-tight text-slate-900">
                    Tapered <span className="text-blue-600">Button Bits</span>
                </h2>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 md:gap-4">
                {['Sandco', 'Blue Tapper', 'Pulanka', 'LT', 'Nanchang', 'PLKS'].map((brand) => (
                    <div key={brand} className="group border border-gray-100 p-6 md:p-8 flex flex-col items-center justify-center hover:bg-slate-900 hover:border-slate-900 transition-all transform-gpu cursor-default">
                        ...
                        <span className="text-2xl md:text-3xl font-bold uppercase tracking-widest text-slate-400 group-hover:text-white text-center">{brand}</span>
                    </div>
                ))}
            </div>
        </div>
        ...
        <div className="relative bg-slate-900 p-10 md:p-16 lg:p-24 text-center rounded-none overflow-hidden">
            <h3 className="text-3xl md:text-5xl lg:text-7xl font-bold text-white mb-6 md:mb-8 uppercase italic tracking-tighter leading-tight md:leading-none relative z-10">
                SECURE YOUR <br /> <span className="text-blue-600 relative">
                  SITE EFFICIENCY.
            ...
            <div className="relative inline-block w-full md:w-auto">
              <div className="absolute -top-12 left-1/2 -translate-x-1/2 font-['Caveat'] text-blue-400 text-2xl hidden md:block">
                Start Today!
              </div>
              <button
                onClick={() => navigate("/contactus")}
                className="relative z-10 w-full md:w-auto bg-blue-600 text-white px-10 md:px-20 py-5 md:py-6 font-bold uppercase text-xs tracking-[0.2em] md:tracking-[0.4em] hover:bg-white hover:text-blue-600 transition-all shadow-2xl active:scale-95 transform-gpu"
              >
                Get B2B Pricing
              </button>
            </div>
