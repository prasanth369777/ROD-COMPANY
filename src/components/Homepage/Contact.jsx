...
export default function Contact() {
  ...
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hi Sri Kumar Drill Rods, I am inquiring about industrial products. Please provide B2B pricing and delivery timelines.`;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-4 space-y-8">
               ...
               <div className="space-y-10">
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      ...
                      <p className="text-slate-800 font-bold text-xl tracking-widest">+91 99944 68589</p>
                    </div>
                  </div>
            ...
            <div className="bg-slate-900 rounded-[2.5rem] p-10 text-white border border-white/5 shadow-2xl relative overflow-hidden">
               <ShieldCheck className="absolute top-5 right-5 text-blue-500/20" size={60} />
          ...
          <div className="lg:col-span-8 bg-white rounded-[3rem] p-8 md:p-16 border border-slate-100 shadow-2xl">
            <div className="mb-10">
               <h4 className="text-slate-900 font-bold uppercase text-xs tracking-[0.3em] mb-4">Contractor & Agency Inquiries</h4>
               <p className="text-slate-500 font-medium italic text-sm">We welcome inquiries from contractors, government agencies, and repair workshops looking for a dependable mining tools supplier in Tamilnadu.</p>
            </div>
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 ml-2">Contact Person</label>
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 ml-2">Email / Business ID</label>
                  <input
                    type="email"
                    name="email"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 ml-2">Technical Category</label>
                  <select
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 ml-2">Message & Details</label>
                <textarea
                  name="message"
