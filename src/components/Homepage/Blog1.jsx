      ...
      <div className="max-w-[1800px] mx-auto px-6 lg:px-16 relative z-10">
        ...
        <div className="text-center mb-16 md:mb-24">
          <div className="flex items-center justify-center gap-3 mb-6">
             <Factory className="text-blue-500 w-4 h-4 md:w-5 md:h-5" />
          ...
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 md:mb-8 uppercase tracking-tighter italic leading-tight md:leading-none">
            Technical <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-red-600 font-bold">Insights</span>
          </h2>
            ...
            >
              ...
              <div className="w-full md:w-[45%] h-60 sm:h-72 md:h-auto overflow-hidden relative">
                ...
                <div className="absolute top-4 left-4">
                    <div className="bg-blue-600 text-white p-2 rounded-lg shadow-xl">
              ...
              <div className="p-6 sm:p-8 md:p-10 md:w-[55%] flex flex-col justify-between">
                <div>
                    ...
                    <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-slate-900 mb-4 leading-tight hover:text-blue-600 transition-colors cursor-pointer tracking-tighter uppercase italic">
                    {blog.title}
                    </h3>
                    
                    <p className="text-slate-500 text-sm md:text-base leading-relaxed mb-6 md:mb-8 font-normal border-l-2 md:border-l-4 border-blue-500/10 pl-4 md:pl-6 italic">
                    {blog.description}
                    </p>
                </div>
                ...
                <div className="flex items-center justify-between pt-6 md:pt-8 border-t border-slate-50">
                  <div className="flex flex-wrap items-center gap-3 md:gap-6">
                    <div className="flex items-center gap-2 text-[9px] md:text-[11px] font-semibold text-slate-400 uppercase tracking-widest">
                      <User size={12} className="text-blue-500" /> {blog.author}
                    </div>
                    <div className="flex items-center gap-2 text-[9px] md:text-[11px] font-semibold text-slate-400 uppercase tracking-widest">
                      <Clock size={12} className="text-blue-500" /> {blog.date}
                    </div>
                  </div>
                  
                  <a
                    href="/"
                    className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center bg-slate-50 text-slate-900 hover:bg-blue-600 hover:text-white transition-all rounded-xl shadow-inner group/btn"
                  >
        ...
        <div
          className="absolute w-[400px] md:w-[800px] h-[400px] md:h-[800px] bg-blue-400/5 rounded-full blur-[100px] md:blur-[150px] pointer-events-none transition-transform duration-1000 ease-out hidden sm:block"
          style={{
        ...
        <div className="mt-16 md:mt-32 text-center relative z-10">
          <button className="w-full sm:w-auto px-10 md:px-20 py-6 md:py-8 bg-slate-900 text-white font-bold text-[11px] md:text-[13px] uppercase tracking-[0.3em] md:tracking-[0.4em] hover:bg-blue-600 transition-all active:scale-95 flex items-center justify-center gap-4 md:gap-6 mx-auto group rounded-xl md:rounded-2xl shadow-2xl">
