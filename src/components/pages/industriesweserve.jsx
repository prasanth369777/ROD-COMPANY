...
export default function IndustriesWeServe() {
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-blue-600/5 rounded-full filter blur-[150px] pointer-events-none z-0 animate-pulse" />
      ...
      <div className="max-w-screen-2xl mx-auto px-6 lg:px-12 w-full relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 md:mb-24 gap-8">
          <div className="max-w-3xl">
            <span className="text-blue-500 font-mono text-[10px] tracking-[0.5em] uppercase mb-3 block">
            ...
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-light uppercase tracking-tighter italic leading-none mb-6 text-white font-['Poppins']">
              Industries <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-red-600 font-normal not-italic">We Serve</span>
            </h2>
          ...
          <button
            ...
            className="group relative overflow-hidden bg-transparent text-white border border-white/20 px-8 py-4 font-bold uppercase text-[10px] tracking-[0.2em] transition-all duration-300 hover:border-blue-500 active:scale-95 flex items-center gap-3"
          >
            <div className="absolute inset-0 w-0 bg-gradient-to-r from-blue-600 to-red-600 transition-all duration-500 ease-out group-hover:w-full" />
            <span className="relative z-10 group-hover:text-white transition-colors">Request B2B Pricing</span>
            <span className="relative z-10 text-blue-500 group-hover:text-white">&rarr;</span>
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center min-h-[480px]">
          ...
          <div className="lg:col-span-5 space-y-4">
            {INDUSTRIES.map((industry) => (
              ...
              >
                <div className={`absolute top-0 right-0 w-[1px] h-full bg-gradient-to-b from-transparent via-blue-500 to-transparent opacity-30 ${activeIndustry === industry.id ? "opacity-100" : ""}`} />
                
                <div className="flex items-start gap-6 relative z-10">
                  <div className="p-3 bg-white/5 border border-white/10 text-blue-500 group-hover:bg-blue-600 group-hover:text-white transition-all duration-500 shrink-0">
                    <Icon icon={industry.icon} className="w-6 h-6 md:w-8 md:h-8" />
                  </div>
                  <div className="flex-1">
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="text-sm md:text-base font-bold uppercase tracking-tight text-white group-hover:text-blue-500 transition-colors">
                        {industry.title}
                      </h3>
                      <span className="text-[10px] font-mono text-slate-500 group-hover:text-blue-500">
                        {industry.stats}
                      </span>
                    </div>
                    ...
                    <div className="mt-4 flex items-center justify-between border-t border-white/5 pt-4">
                      ...
                      <span className={`text-[8px] font-black uppercase text-blue-500 transition-opacity ${
              ...
              >
                <div className="flex flex-col gap-4">
                  ...
                  <div className="mt-12 md:mt-20">
                    <span className="text-blue-600 text-6xl md:text-8xl font-black italic opacity-10 leading-none">
                ...
                <div className="flex flex-col sm:flex-row gap-6 items-center justify-between border-t border-white/5 pt-8">
                  <div className="flex gap-4 items-center">
                    <div className="w-12 h-12 border border-white/10 flex items-center justify-center text-blue-500 animate-spin-slow">
                  ...
                  <button 
                    ...
                    className="w-full sm:w-auto px-8 py-4 bg-blue-600 text-white font-bold uppercase text-[10px] tracking-[0.2em] hover:bg-slate-900 border border-slate-900 transition-all active:scale-95 text-center"
                  >
                    Explore Nodes
                  </button>
                </div>
