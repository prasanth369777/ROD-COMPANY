...
// Importing Assets
import img1 from "../../../assests/productimg/PLKS/1.webp";
import img2 from "../../../assests/productimg/PLKS/2.webp";
import img3 from "../../../assests/productimg/PLKS/3.webp";
import img4 from "../../../assests/productimg/PLKS/6.webp";
import img5 from "../../../assests/productimg/PLKS/5.webp";

const productImages = [img1, img2, img3, img4, img5];

export default function PLKSProductPage() {
  ...
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hi Sri Kumar Drill Rods, I am inquiring about the PLKS Tapper Button Bits. Please provide B2B pricing and delivery timelines.`;
  ...
  return (
    <div className="bg-white font-['Inter'] text-slate-900 overflow-x-hidden antialiased">
      {/* SEO META DATA */}
      <head>
        <title>PLKS Tapper Button Bits Supplier Tamil Nadu | Sri Kumar Drill Rods</title>
        <meta name="description" content="Buy PLKS Tapper Button Bits in Tamil Nadu at competitive prices. Trusted B2B supplier for mining, quarrying and borewell drilling equipment." />
        <link rel="canonical" href="https://srikumardrillrods.com/plks-tapper-button-bits-tamil-nadu" />
      </head>
            ...
            <div className="lg:col-span-7">
              ...
              <div className="flex items-start gap-6 mb-12">
                 ...
                 <h2 className="text-xl lg:text-2xl font-['Poppins'] font-medium text-slate-700 leading-tight">
                    Heavy-Duty Tapper Button Bits Supplier in Tamil Nadu
                 </h2>
              </div>

              <div className="max-w-xl space-y-10">
                <p className="text-slate-500 text-lg lg:text-xl leading-relaxed border-l-2 border-slate-200 pl-8 font-light italic">
                  Sri Kumar Drill Rods supplies premium-grade PLKS Tapper Button Bits designed for high-impact rock drilling applications. As a trusted Tapper Button Bits supplier in Tamil Nadu, we provide durable and cost-effective drilling solutions for mining contractors, quarry operators, and borewell drilling professionals.
                </p>
                ...
                <div className="pl-8 flex items-center gap-4 text-slate-400">
                   <p className="italic text-base lg:text-lg leading-relaxed font-light">
                     The PLKS model is engineered to deliver strong penetration performance, extended service life, and consistent drilling efficiency in medium to hard rock formations.
                   </p>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
               <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-2xl border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                  ...
                  <div className="w-full h-full flex items-center justify-center relative z-10 transition-transform duration-700 group-hover:scale-105">
                     <img src={activeImg} className="max-h-full w-auto object-contain filter drop-shadow-xl" alt="PLKS Main Asset" />
                  </div>
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[80%] bg-white/70 backdrop-blur-md border border-white/40 py-4 px-6 text-center shadow-lg">
                     <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 block mb-1">PLKS Series</span>
                     <h3 className="text-sm font-['Poppins'] font-bold uppercase text-slate-800 tracking-tighter italic leading-none">High-Impact Bit</h3>
                  </div>
               </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-8">
              ...
              <div className="space-y-6 text-xl lg:text-2xl text-slate-500 leading-relaxed font-normal max-w-3xl mb-12">
                <p>
                  PLKS Tapper Button Bits are manufactured using high-quality alloy steel combined with precision-engineered tungsten carbide buttons. The design ensures optimal energy transfer, reduced wear, and stable drilling operation even under demanding working conditions.
                </p>
              </div>
              <div className="flex items-center gap-6 p-8 bg-[#fafafa] border border-slate-100 max-w-2xl shadow-sm">
                ...
                <p className="text-slate-600 text-lg font-medium tracking-tight leading-tight">
                  Sri Kumar Drill Rods maintains ready stock and supports bulk supply across Tamil Nadu for uninterrupted project execution.
                </p>
              </div>
            </div>
            <div className="lg:col-span-4 grid grid-cols-2 gap-4">
               <div className="bg-[#fafafa] p-8 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100">
                  <Filter className="text-blue-600 mb-3 w-8 h-8 stroke-[1px]" />
               ...
               <div className="bg-[#fafafa] p-8 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100 mt-6">
                  ...
                  <span className="text-[10px] font-medium uppercase tracking-widest text-slate-400 mt-2">Engineered</span>
               </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6">
          <div className="mb-20 text-center">
            ...
            <p className="text-slate-400 font-medium uppercase tracking-[0.4em] text-[10px]">Forged for High Impact</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              "High-impact resistant alloy steel body",
              "Premium tungsten carbide button inserts",
              "Strong penetration rate",
              "Excellent wear and abrasion resistance",
              "Accurate tapper angle fitment",
              ...
              <div key={idx} className="p-10 bg-[#fafafa] border border-slate-100 hover:bg-white hover:shadow-2xl transition-all group duration-500">
                <ChevronRight className="text-slate-300 group-hover:text-blue-600 mb-8 w-10 h-10 transition-colors stroke-[1px]" />
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            <div className="lg:w-5/12 bg-white p-10 lg:p-16 border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-between">
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-12">
                  ...
                  <h2 className="text-4xl lg:text-[3rem] font-['Poppins'] font-medium uppercase italic tracking-tighter leading-[0.9]">
                    Technical <br /> <span className="font-light text-slate-300">Specifications</span>
                  </h2>
                </div>
                <div className="space-y-2">
                  {[
                    ...
                    { label: "Button Design", val: "Spherical / Ballistic", detail: "Premium" },
                    { label: "Drilling Method", val: "Top Hammer Drilling", detail: "Method" },
                    { label: "Compatibility", val: "Standard Tapper Drill Rods", detail: "Universal" },
                    { label: "Suitable For", val: "Mining, Quarrying, Borewell", detail: "Projects" }
                  ].map((spec, i) => (
              ...
              <div className="mt-10 p-6 bg-slate-900 text-white text-[10px] font-bold uppercase tracking-widest text-center">
                Bulk orders and dealer supply available.
              </div>
            </div>
            ...
            <div className="lg:w-7/12 flex flex-col gap-6">
              <div className="flex-grow bg-white border border-slate-200 shadow-sm relative group overflow-hidden flex flex-col items-center justify-center p-12">
                 <img src={activeImg} className="max-h-[350px] w-auto object-contain transition-all duration-700 group-hover:scale-105" alt="PLKS active showcase" />
              </div>
              <div className="grid grid-cols-5 gap-4">
                 {productImages.map((img, index) => (
                    <button 
                       ...
                       className={`aspect-square p-4 bg-white border transition-all duration-300 ${activeImg === img ? 'border-blue-600 shadow-xl scale-95' : 'border-slate-200 opacity-60 hover:opacity-100'}`}
                    >
      ...
      <section className="py-24 bg-white text-center">
        <div className="max-w-screen-2xl mx-auto px-6">
          <h2 className="text-5xl lg:text-[4rem] font-['Poppins'] font-medium uppercase italic tracking-tighter mb-20 leading-[0.8]">
            Drilling <span className="text-blue-600 font-semibold">Applications</span>
          </h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6 text-left">
            {[
              "Granite Quarry Operations",
              "Blue Metal Quarrying",
              "Mining Projects",
              "Borewell Drilling",
          ...
          <p className="mt-20 text-center text-slate-400 italic text-lg font-light tracking-wide">Designed to perform efficiently in Tamil Nadu’s tough rock conditions.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#fafafa] border-y border-slate-100">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          <h2 className="text-5xl lg:text-[3.5rem] font-['Poppins'] font-medium uppercase italic tracking-tighter mb-24 leading-none">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-200 border border-slate-200 shadow-xl text-center">
            {[
              "Authorized PLKS Drill Tool Supplier",
          ...
          <p className="mt-16 text-slate-400 italic text-xl font-light">We focus on delivering cost-effective drilling solutions without compromising on quality.</p>
        </div>
      </section>
      ...
      <section className="py-40 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
          <h2 className="text-6xl lg:text-[5.5rem] font-['Poppins'] font-light uppercase italic tracking-tighter mb-8 leading-none text-white">Bulk Orders <br /> <span className="font-semibold text-blue-600">& Enquiry</span></h2>
          <div className="w-20 h-[1px] bg-blue-600 mx-auto mb-16"></div>
          <p className="text-2xl font-['Poppins'] font-light mb-10 uppercase tracking-[0.4em] opacity-60 italic leading-snug">Looking for a dependable PLKS Tapper Button Bits Supplier?</p>
          ...
          <div className="flex flex-col sm:flex-row gap-10 justify-center items-center">
             ...
             <a href={whatsappLink} target="_blank" rel="noreferrer" className="w-full sm:w-auto px-16 py-8 border border-white/20 text-white font-['Poppins'] font-semibold uppercase text-[10px] tracking-[0.4em] hover:bg-white hover:text-slate-900 transition-all flex items-center justify-center gap-6">
