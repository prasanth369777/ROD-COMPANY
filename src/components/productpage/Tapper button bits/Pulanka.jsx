...
export default function ProductPage() {
  ...
  return (
    <div className="bg-white font-['Inter'] text-slate-900 overflow-x-hidden">
      {/* SEO META DATA */}
      <head>
        <title>Pulanka Tapper Button Bits Supplier Tamil Nadu | Sri Kumar Drill Rods</title>
        <meta name="description" content="Buy Pulanka Tapper Button Bits in Tamil Nadu at competitive prices. Trusted B2B supplier for mining, quarrying, and borewell drilling tools." />
        <link rel="canonical" href="https://srikumardrillrods.com/pulanka-tapper-button-bits-tamil-nadu" />
      </head>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-6">
              ...
              <div className="flex items-start gap-6 mb-12">
                 ...
                 <p className="text-xl lg:text-2xl font-['Poppins'] font-medium text-slate-700 leading-tight">
                   Premium Quality Tapper Button Bits Supplier in Tamil Nadu
                 </p>
              </div>

              <div className="max-w-xl space-y-10">
                <p className="text-slate-500 text-lg lg:text-xl leading-relaxed font-normal border-l-2 border-slate-200 pl-8">
                  Sri Kumar Drill Rods offers Pulanka Tapper Button Bits designed for efficient rock drilling in mining, quarrying, and construction applications. As a trusted drilling tools supplier in Tamil Nadu, we provide high-quality tapper button bits at competitive prices for borewell contractors, mining operators, and infrastructure companies.
                </p>
                
                <div className="pl-8 flex items-center gap-4 text-slate-400">
                   <QuoteIcon className="w-6 h-6 opacity-20" />
                   <p className="italic text-base font-medium">
                    Engineered for durability and precise penetration in tough rock formations.
                   </p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 mt-16">
                <button className="px-12 py-5 bg-slate-900 text-white font-['Poppins'] font-bold uppercase text-[11px] tracking-[0.2em] hover:bg-red-600 transition-all shadow-xl active:scale-95 flex items-center justify-center gap-3">
                  Bulk Quote <ArrowRight className="w-4 h-4" />
                </button>
                <button className="px-12 py-5 border border-slate-200 text-slate-900 font-['Poppins'] font-bold uppercase text-[11px] tracking-[0.2em] hover:bg-slate-50 transition-all flex items-center justify-center gap-3">
                  Technical Support
                </button>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 relative flex justify-center lg:justify-end">
               <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-[0_50px_100px_-20px_rgba(0,0,0,0.12)] border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                  ...
                  <div className="absolute top-8 left-8 text-[12px] font-mono text-slate-200 tracking-widest uppercase rotate-90 origin-left">
                    Ref: PUL-SERIES-2026
                  </div>
                  ...
                  <div className="w-full h-full flex items-center justify-center relative z-10 transition-transform duration-700 group-hover:scale-105">
                     <img 
                       src={activeImg} 
                       className="max-h-full w-auto object-contain filter drop-shadow-[0_20px_40px_rgba(0,0,0,0.1)]" 
                       alt="Pulanka Industrial Asset" 
                     />
                  </div>
                  
                  {/* Glassmorphism Product Title Overlay */}
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[80%] bg-white/70 backdrop-blur-md border border-white/40 py-4 px-6 text-center shadow-lg">
                     <span className="text-[10px] font-black uppercase tracking-[0.3em] text-red-600 block mb-1">Sri Kumar Original</span>
                     <h3 className="text-sm font-['Poppins'] font-bold uppercase text-slate-800 tracking-tighter italic leading-none">Pulanka Tapper Bit</h3>
                  </div>
               </div>
               
               {/* Aesthetic Gears */}
               <div className="absolute -bottom-10 -right-10 w-48 h-48 bg-slate-50 rounded-full flex items-center justify-center -z-10 border border-slate-100 animate-spin-slow">
                  <Cog className="w-32 h-32 text-slate-100" />
               </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-8">
              ...
              <p className="text-xl lg:text-2xl text-slate-500 leading-relaxed font-normal max-w-3xl mb-12">
                Pulanka Tapper Button Bits are manufactured using high-grade alloy steel and premium carbide buttons to deliver superior impact resistance and wear protection. Designed for compatibility with standard tapper rods, these bits ensure strong energy transfer and stable drilling operation.
              </p>
              <div className="flex items-center gap-6 p-8 bg-[#fafafa] border border-slate-100 max-w-2xl">
                ...
                <p className="text-slate-600 text-lg font-bold uppercase tracking-tight leading-tight">
                  Sri Kumar Drill Rods supplies bulk quantities across Tamil Nadu with reliable stock availability and fast dispatch support.
                </p>
              </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6">
          <div className="mb-20 text-center">
            ...
            <p className="text-slate-400 font-bold uppercase tracking-[0.4em] text-[10px]">Forged for Extreme Environments</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              "High-strength alloy steel body",
              "Premium carbide button inserts",
              "Excellent penetration rate",
              "Strong wear resistance",
              "Precision-engineered tapper angle",
              "Compatible with standard tapper drill rods",
      ...
      {/* --- SECTION 3: STUDIO SHOWCASE & SPECS --- */}
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            <div className="lg:w-5/12 bg-white p-10 lg:p-16 border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-between">
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-12">
                  ...
                  <h2 className="text-4xl lg:text-[3rem] font-['Poppins'] font-black uppercase italic tracking-tighter leading-[0.9]">Technical <br /> Data Sheet</h2>
                </div>
                <div className="space-y-2">
                  {[
                    { label: "Bit Diameter", val: "28mm to 42mm", detail: "Range" },
                    { label: "Tapper Angle", val: "7°, 11°, 12°", detail: "Angles" },
                    { label: "Button Type", val: "Spherical / Ballistic", detail: "Type" },
                    { label: "Application", val: "Top hammer drilling", detail: "Core" },
                    { label: "Usage", val: "Mining, Quarry, Borewell", detail: "Industry" }
                  ].map((spec, i) => (
                    <div key={i} className="group flex items-center justify-between py-5 border-b border-slate-100 hover:bg-slate-50 transition-all px-2">
                      ...
                      <div className="px-3 py-1 border border-slate-200 rounded-none"><span className="text-[9px] font-bold text-slate-400 tracking-widest uppercase">{spec.detail}</span></div>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="lg:w-7/12 flex flex-col gap-6">
              <div className="flex-grow bg-white border border-slate-200 shadow-sm relative group overflow-hidden flex flex-col items-center justify-center p-12">
                 ...
                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.02] text-[20rem] font-['Poppins'] font-black pointer-events-none select-none">PUL</div>
                 
                 <div className="relative z-10 w-full h-full flex flex-col items-center justify-center">
                    <img 
                       src={activeImg} 
                       className="max-h-[350px] w-auto object-contain transition-all duration-700 group-hover:translate-y-[-20px]" 
                       alt="Active Product" 
                    />
                    <div className="mt-12 text-center opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-10 group-hover:translate-y-0">
                       <span className="text-red-600 font-black text-[10px] uppercase tracking-[0.6em] mb-2 block">Series Overview</span>
                       <h3 className="text-2xl font-['Poppins'] font-black uppercase italic text-slate-900 tracking-tighter">Premium Tapper Series</h3>
                    </div>
                 </div>
              </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6 text-left">
            {["Granite Quarrying", "Mining Operations", "Borewell Drilling", "Infrastructure Projects", "Underground Drilling"].map((app, i) => (
      ...
      <section className="py-24 bg-[#fafafa] border-y border-slate-100">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          <h2 className="text-5xl lg:text-[4rem] font-['Poppins'] font-black uppercase italic tracking-tighter mb-24">Why Sri Kumar?</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-200 border border-slate-200 shadow-xl">
            {[
              "Trusted Drill Tool Supplier",
              "Competitive Bulk Pricing",
              "Consistent Quality Assurance",
              "Quick Delivery Tamil Nadu",
      ...
      <section className="py-24 bg-white text-center">
        <div className="max-w-screen-2xl mx-auto px-6">
          <h3 className="text-3xl font-['Poppins'] font-black uppercase italic mb-16 tracking-tighter">Primary Markets</h3>
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4">
            {["Coimbatore", "Salem", "Chennai", "Madurai", "Trichy", "Erode", "Namakkal", "Tirunelveli"].map((city) => (
              <div key={city} className="py-8 border border-slate-100 flex flex-col items-center gap-3 group hover:border-red-600 transition-all">
      ...
      <section className="py-40 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
          <h2 className="text-6xl lg:text-[5.5rem] font-['Poppins'] font-black uppercase italic tracking-tighter mb-8 leading-[0.85]">
            Bulk Orders <br className="hidden lg:block" /> & Enquiries
          </h2>
          <div className="w-20 h-[1px] bg-red-600 mx-auto mb-16"></div>
          <p className="text-2xl font-['Poppins'] font-bold mb-20 uppercase tracking-[0.4em] opacity-60">Ready For Dispatch</p>
          
          <div className="flex flex-col sm:flex-row gap-10 justify-center items-center">
             <button className="w-full sm:w-auto px-20 py-8 bg-white text-slate-900 font-['Poppins'] font-black uppercase text-[11px] tracking-[0.4em] hover:bg-red-600 hover:text-white transition-all shadow-2xl flex items-center gap-6">
