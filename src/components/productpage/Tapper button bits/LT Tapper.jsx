    ...
    <div className="bg-white font-['Inter'] text-slate-900 overflow-x-hidden">
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
               <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-[0_50px_100px_-20px_rgba(0,0,0,0.12)] border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                  ...
                  <div className="w-full h-full flex items-center justify-center relative z-10 transition-transform duration-700 group-hover:scale-105">
                     <img src={activeImg} className="max-h-full w-auto object-contain filter drop-shadow-[0_20px_40px_rgba(0,0,0,0.1)]" alt="LT Button Bit Main" />
                  </div>
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[85%] bg-white/70 backdrop-blur-md border border-white/40 py-4 px-6 text-center shadow-lg">
                     <span className="text-[10px] font-black uppercase tracking-[0.3em] text-red-600 block mb-1">LT Engineering</span>
                     <h3 className="text-sm font-['Poppins'] font-bold uppercase text-slate-800 tracking-tighter italic">High Penetration Series</h3>
                  </div>
               </div>
            </div>
          </div>
        ...
        <div className="max-w-screen-2xl mx-auto px-6">
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-8">
              ...
              <p className="text-xl lg:text-2xl text-slate-500 leading-relaxed max-w-3xl mb-12">
              ...
              <div className="flex items-center gap-6 p-8 bg-[#fafafa] border border-slate-100 max-w-2xl shadow-sm">
                <div className="h-12 w-1.5 bg-orange-500"></div>
                <p className="text-slate-600 text-lg font-bold uppercase tracking-tight">
                  Sri Kumar Drill Rods ensures ready stock availability and bulk supply support across Tamil Nadu.
                </p>
              </div>
            </div>
            <div className="lg:col-span-4 flex flex-col gap-6">
               <div className="bg-[#fafafa] p-10 flex flex-col items-center justify-center text-center border border-slate-100 hover:shadow-lg transition-all">
                  <Cog className="text-red-600 mb-4 w-10 h-10 animate-spin-slow" />
                  <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">High-Grade Alloy</span>
               </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            <div className="lg:w-5/12 bg-white p-10 lg:p-16 border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-between">
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-12">
                  ...
                  <h2 className="text-4xl lg:text-[3rem] font-['Poppins'] font-black uppercase italic tracking-tighter leading-[0.9]">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={i} className="group flex items-center justify-between py-5 border-b border-slate-100 hover:bg-slate-50 transition-all px-2">
                      ...
                      <div className="px-3 py-1 border border-slate-200 rounded-none"><span className="text-[9px] font-bold text-slate-400 uppercase">{spec.detail}</span></div>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="lg:w-7/12 flex flex-col gap-6">
              <div className="flex-grow bg-white border border-slate-200 shadow-sm relative group overflow-hidden flex flex-col items-center justify-center p-12">
                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.02] text-[20rem] font-['Poppins'] font-black pointer-events-none select-none">LT</div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          ...
          <p className="mt-20 text-center text-slate-400 italic text-lg font-medium">Designed to handle tough geological conditions across Tamil Nadu.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#fafafa] border-y border-slate-100">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          ...
          <p className="mt-16 text-slate-400 italic text-xl">We focus on delivering cost-effective drilling solutions without compromising on quality.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white text-center">
        <div className="max-w-screen-2xl mx-auto px-6">
          <h2 className="text-4xl lg:text-[3rem] font-['Poppins'] font-black uppercase italic mb-16 tracking-tighter text-slate-900">Supplying Across <span className="text-red-600">Tamil Nadu</span></h2>
      ...
      <section className="py-40 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
          <h2 className="text-6xl lg:text-[5.5rem] font-['Poppins'] font-black uppercase italic tracking-tighter mb-10 leading-none">Bulk Enquiry <br /> & Orders</h2>
          <div className="w-20 h-[1px] bg-red-600 mx-auto mb-16"></div>
          <p className="text-2xl font-['Poppins'] font-bold mb-10 uppercase tracking-[0.3em] opacity-60 italic">Looking for a dependable LT Tapper Button Bits Supplier?</p>
          <p className="text-xl mb-12 italic opacity-80">Contact Sri Kumar Drill Rods today for competitive pricing and bulk order support.</p>
