...
import img1 from "../../../assests/productimg/LT (1)/1.webp";
import img2 from "../../../assests/productimg/LT (1)/2.webp";
import img3 from "../../../assests/productimg/LT (1)/3.webp";
import img4 from "../../../assests/productimg/LT (1)/4.webp";
import img5 from "../../../assests/productimg/LT (1)/1.webp";

const productImages = [img1, img2, img3, img4, img5];

export default function LTProductPage() {
  ...
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hi Sri Kumar Drill Rods, I am inquiring about the LT Tapper Button Bits. Please provide B2B pricing and delivery timelines.`;
  ...
  return (
    <div className="bg-white font-['Inter'] text-slate-900 overflow-x-hidden antialiased">
      {/* SEO META DATA */}
      <head>
        <title>LT Tapper Button Bits Supplier Tamil Nadu | Sri Kumar Drill Rods</title>
        <meta name="description" content="Buy LT Tapper Button Bits in Tamil Nadu at competitive prices. Trusted B2B supplier for mining, quarrying and borewell drilling tools." />
        <link rel="canonical" href="https://srikumardrillrods.com/lt-tapper-button-bits-tamil-nadu" />
      </head>
            ...
            <div className="lg:col-span-7">
              ...
              <div className="flex items-start gap-6 mb-12">
                 ...
                 <h2 className="text-xl lg:text-2xl font-['Poppins'] font-medium text-slate-700 leading-tight">
                    High-Quality Tapper Button Bits Supplier in Tamil Nadu
                 </h2>
              </div>

              <div className="max-w-xl space-y-10">
                <p className="text-slate-500 text-lg lg:text-xl leading-relaxed border-l-2 border-slate-200 pl-8 font-light italic">
                  Sri Kumar Drill Rods supplies premium quality LT Tapper Button Bits designed for reliable and efficient rock drilling applications. As a trusted Tapper Button Bits supplier in Tamil Nadu, we provide durable drilling solutions at competitive prices for mining contractors, quarry operators, and borewell drilling companies.
                </p>
                ...
                <div className="pl-8 flex items-center gap-4 text-slate-400">
                   <p className="italic text-base lg:text-lg leading-relaxed font-light">
                    Our LT tapper button bits are engineered to deliver excellent penetration rates, strong wear resistance, and consistent performance in hard rock formations commonly found across Tamil Nadu.
                   </p>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
               <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-2xl border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                  ...
                  <div className="w-full h-full flex items-center justify-center relative z-10 transition-transform duration-700 group-hover:scale-105">
                     <img src={activeImg} className="max-h-full w-auto object-contain filter drop-shadow-xl" alt="LT Button Bit Main" />
                  </div>
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[85%] bg-white/70 backdrop-blur-md border border-white/40 py-4 px-6 text-center shadow-lg">
                     <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 block mb-1">LT Engineering</span>
                     <h3 className="text-sm font-['Poppins'] font-bold uppercase text-slate-800 tracking-tighter italic leading-none">High Penetration Series</h3>
                  </div>
               </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-8">
              ...
              <p className="text-xl lg:text-2xl text-slate-500 leading-relaxed font-normal max-w-3xl mb-12">
                LT Tapper Button Bits are manufactured using high-grade alloy steel and precision-fitted carbide buttons to ensure durability and high impact resistance. Designed for compatibility with standard tapper drill rods, these bits provide stable drilling performance with efficient energy transfer.
              </p>
              <div className="flex items-center gap-6 p-8 bg-[#fafafa] border border-slate-100 max-w-2xl shadow-sm">
                ...
                <p className="text-slate-600 text-lg font-medium tracking-tight leading-tight">
                  Sri Kumar Drill Rods ensures ready stock availability and bulk supply support across Tamil Nadu.
                </p>
              </div>
            </div>
            <div className="lg:col-span-4 grid grid-cols-2 gap-4">
               <div className="bg-[#fafafa] p-8 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100">
                  <Cog className="text-blue-600 mb-3 w-8 h-8 stroke-[1px]" />
                  <span className="text-[10px] font-medium uppercase tracking-widest text-slate-400 mt-2">Alloy Steel</span>
               </div>
               <div className="bg-[#fafafa] p-8 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100 mt-6">
                  ...
                  <span className="text-[10px] font-medium uppercase tracking-widest text-slate-400 mt-2">Hard Rock</span>
               </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
               ...
               <p className="text-slate-400 text-lg font-light leading-relaxed mb-12 max-w-md">
                 Explore our high-precision catalogue through our automated showcase. We prioritize visual transparency for all our industrial OES spares.
               </p>
               <div className="flex items-center gap-4">
                  <div className="text-white font-light text-5xl italic">0{slideIndex + 1}</div>
                  <div className="h-[1px] w-24 bg-blue-600"></div>
                  <div className="text-slate-500 font-semibold uppercase tracking-[0.4em] text-[9px]">OES Index</div>
               </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6">
          <div className="mb-20 text-center">
            ...
            <p className="text-slate-400 font-medium uppercase tracking-[0.4em] text-[10px]">Forged for Extreme Environments</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              "High-strength alloy steel construction",
              "Premium tungsten carbide button inserts",
              "Superior penetration speed",
              "Long service life",
              "Strong resistance to abrasion and impact",
              "Accurate tapper angle fit",
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-stretch">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { label: "Tapper Angles", val: "7°, 11°, 12°", detail: "Precise Fit" },
                    { label: "Button Type", val: "Spherical / Ballistic", detail: "Premium Grade" },
                    { label: "Application Type", val: "Top Hammer Drilling", detail: "Heavy Duty" },
                    { label: "Compatibility", val: "Standard Tapper Drill Rods", detail: "Universal" },
                    { label: "Usage", val: "Mining, Quarry, Borewell", detail: "Multi-Purpose" }
                  ].map((spec, i) => (
            ...
            <div className="lg:w-7/12 flex flex-col gap-6">
              <div className="flex-grow bg-white border border-slate-200 shadow-sm relative group overflow-hidden flex flex-col items-center justify-center p-12">
                 <img src={activeImg} className="max-h-[350px] w-auto object-contain transition-all duration-700 group-hover:scale-105" alt="LT showcase" />
              </div>
      ...
      <section className="py-24 bg-white text-center">
        <div className="max-w-screen-2xl mx-auto px-6">
          ...
          <p className="mt-20 text-center text-slate-400 italic text-lg font-light tracking-wide">Designed to handle tough geological conditions across Tamil Nadu.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#fafafa] border-y border-slate-100">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-200 border border-slate-200 shadow-xl text-center">
            {[
              "Authorized LT Drill Tool Supplier",
      ...
      <section className="py-24 bg-white text-center border-b border-slate-50">
        <div className="max-w-screen-2xl mx-auto px-6">
          ...
          <p className="mt-10 text-slate-400 font-medium uppercase tracking-[0.4em] text-[10px]">All Major Quarry & Mining Zones</p>
        </div>
      </section>
      ...
      <section className="py-40 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
          ...
          <p className="text-2xl font-['Poppins'] font-light mb-10 uppercase tracking-[0.4em] opacity-60 italic leading-snug">Looking for a dependable LT Tapper Button Bits Supplier?</p>
