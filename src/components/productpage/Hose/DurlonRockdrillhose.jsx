    ...
    <div className="bg-white font-['Inter'] text-slate-900 overflow-x-hidden">
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
               <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-2xl border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                  ...
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[80%] bg-white/70 backdrop-blur-md border border-white/40 py-4 px-6 text-center shadow-lg">
                     <span className="text-[10px] font-black uppercase tracking-[0.3em] text-red-600 block mb-1">Reinforced Rubber</span>
                     <h3 className="text-sm font-['Poppins'] font-bold uppercase text-slate-800 tracking-tighter italic leading-none">Durlon High-Pressure Series</h3>
                  </div>
               </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-4 grid grid-cols-2 gap-4">
               <div className="bg-[#fafafa] p-8 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100">
                  <Wind className="text-red-600 mb-3 w-8 h-8" />
                  <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Air Flow</span>
               </div>
               <div className="bg-[#fafafa] p-8 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100 mt-6">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">High Pressure</span>
               </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6">
          <div className="mb-20 text-center">
            ...
            <p className="text-slate-400 font-bold uppercase tracking-[0.4em] text-[10px]">Forged for Industrial Drilling Efficiency</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            <div className="lg:w-5/12 bg-white p-10 lg:p-16 border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-between">
              <div className="relative z-10">
                ...
                <div className="space-y-2">
                  {[
                    { label: "Inner Diameter", val: "Industry Standard", detail: "Multi-size" },
                    { label: "Length", val: "Standard & Custom", detail: "Flexible" },
                    { label: "Working Pressure", val: "High-Pressure Range", detail: "Heavy Duty" },
                    { label: "Material", val: "Reinforced Synthetic Rubber", detail: "Durlon Grade" },
                    { label: "Application", val: "Pneumatic Rock Drilling", detail: "Pro-Series" }
                  ].map((spec, i) => (
            ...
            <div className="lg:w-7/12 flex flex-col gap-6">
              <div className="flex-grow bg-white border border-slate-200 shadow-sm relative group overflow-hidden flex flex-col items-center justify-center p-12">
                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.02] text-[18rem] font-['Poppins'] font-black pointer-events-none select-none text-red-600">HOSE</div>
                 <img src={activeImg} className="max-h-[350px] w-auto object-contain transition-all duration-700 group-hover:scale-105" alt="Durlon Hose Showcase" />
              </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          ...
          <p className="mt-20 text-center text-slate-400 italic text-lg font-medium">Designed for reliable performance in Tamil Nadu’s heavy-duty drilling conditions.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#fafafa] border-y border-slate-100">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-200 border border-slate-200 shadow-xl">
            {[
              "Trusted Industrial Hose Supplier in Tamil Nadu",
          ...
          <p className="mt-16 text-slate-400 italic text-xl">We focus on delivering high-performance drilling accessories at cost-effective pricing to support your operational efficiency.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white text-center">
        <div className="max-w-screen-2xl mx-auto px-6">
          ...
          <p className="mt-10 text-slate-400 font-bold uppercase tracking-widest text-[10px]">All major mining and quarry zones in Tamil Nadu</p>
        </div>
      </section>
      ...
      <section className="py-40 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
          ...
          <p className="text-2xl font-['Poppins'] font-bold mb-10 uppercase tracking-[0.4em] opacity-60 italic">Looking for a reliable Durlon Rock Drill Hose supplier in Tamil Nadu?</p>
          <p className="text-xl mb-12 italic opacity-80">Contact Sri Kumar Drill Rods today for competitive pricing and bulk supply support.</p>
