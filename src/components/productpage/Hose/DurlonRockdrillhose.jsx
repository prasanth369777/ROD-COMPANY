...
export default function DurlonHoseProductPage() {
  ...
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hi Sri Kumar Drill Rods, I am inquiring about the Durlon Rock Drill Hose. Please provide B2B pricing and delivery timelines.`;
  ...
  return (
    <div className="bg-white font-['Inter'] text-slate-900 overflow-x-hidden antialiased">
      {/* SEO META DATA */}
      <head>
        <title>Durlon Rock Drill Hose Supplier in Tamil Nadu</title>
        <meta name="description" content="Buy Durlon Rock Drill Hose in Tamil Nadu. Trusted supplier of high-pressure pneumatic drilling hoses for mining, quarry, and construction use." />
        <link rel="canonical" href="https://srikumardrillrods.com/durlon-rock-drill-hose-tamil-nadu" />
      </head>
            ...
            <div className="lg:col-span-7">
              <div className="flex items-center gap-4 mb-10">
                ...
                <span className="text-slate-400 font-['Poppins'] font-medium tracking-[0.4em] uppercase text-[10px]">
                  High-Pressure Pneumatic Solutions
                </span>
              </div>
              ...
              <div className="flex items-start gap-6 mb-12">
                 ...
                 <h2 className="text-xl lg:text-2xl font-['Poppins'] font-medium text-slate-700 leading-tight">
                    Premium Quality Rock Drill Hose Supplier in Tamil Nadu
                 </h2>
              </div>

              <div className="max-w-xl space-y-10">
                <p className="text-slate-500 text-lg lg:text-xl leading-relaxed border-l-2 border-slate-200 pl-8 font-light italic">
                  Sri Kumar Drill Rods offers Durlon Rock Drill Hose designed for high-pressure air transfer in mining, quarrying, and construction drilling applications. As a trusted rock drill hose supplier in Tamil Nadu, we provide durable and high-performance hoses for drilling contractors and mining operators across Tamil Nadu and India.
                </p>
                ...
                <div className="pl-8 flex items-center gap-4 text-slate-400">
                   <p className="italic text-base lg:text-lg leading-relaxed font-light">
                    Our Durlon rock drill hoses are engineered for flexibility, pressure resistance, and long service life in demanding industrial environments.
                   </p>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
               <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-2xl border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                  ...
                  <div className="w-full h-full flex items-center justify-center relative z-10 transition-transform duration-700 group-hover:scale-105">
                     <img src={activeImg} className="max-h-full w-auto object-contain filter drop-shadow-xl" alt="Durlon Rock Drill Hose Asset" />
                  </div>
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[85%] bg-white/90 backdrop-blur-md border border-white/40 py-5 px-6 text-center shadow-lg">
                     <span className="text-[10px] font-medium uppercase tracking-[0.4em] text-blue-600 block mb-1">Reinforced Rubber</span>
                     <h3 className="text-sm font-['Poppins'] font-medium uppercase text-slate-800 tracking-tighter italic leading-none">Durlon High-Pressure Series</h3>
                  </div>
               </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-8">
              ...
              <div className="space-y-6 text-xl lg:text-2xl text-slate-500 leading-relaxed font-normal max-w-3xl mb-12">
                <p>
                  The Durlon Rock Drill Hose is manufactured using high-grade synthetic rubber and reinforced layers to withstand high air pressure and tough working conditions. Designed specifically for pneumatic rock drilling equipment, this hose ensures efficient air flow, minimal leakage, and reliable drilling performance.
                </p>
                <p>
            ...
            <div className="lg:col-span-4 grid grid-cols-2 gap-4">
               <div className="bg-[#fafafa] p-8 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100">
                  ...
                  <span className="text-[10px] font-medium uppercase tracking-widest text-slate-400 mt-2">Flow Control</span>
               </div>
               <div className="bg-[#fafafa] p-8 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100 mt-6">
                  ...
                  <span className="text-[10px] font-medium uppercase tracking-widest text-slate-400 mt-2">Max Efficiency</span>
               </div>
            </div>
          </div>
        </div>
      ...
      {/* --- SECTION: DYNAMIC PRODUCT CATALOG SLIDER --- */}
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              "High-pressure air hose for rock drilling",
              "Strong reinforced synthetic rubber construction",
              "Excellent flexibility and durability",
              "Resistant to abrasion and harsh environments",
              "Reliable performance in heavy-duty operations",
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            <div className="lg:w-5/12 bg-white p-10 lg:p-16 border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-between">
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-12">
                  ...
                  <h2 className="text-4xl lg:text-[2.8rem] font-['Poppins'] font-semibold uppercase italic tracking-tighter leading-[1]">Technical <br /> <span className="font-light text-slate-300">Details</span></h2>
                </div>
            ...
            <div className="lg:w-7/12 flex flex-col gap-6">
              <div className="flex-grow bg-white border border-slate-200 shadow-sm relative group overflow-hidden flex flex-col items-center justify-center p-12">
                 <img src={activeImg} className="max-h-[350px] w-auto object-contain filter drop-shadow-2xl transition-all duration-700" alt="Compressor Hose Showcase" />
              </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          ...
          <p className="mt-20 text-center text-slate-400 italic text-lg font-light tracking-wide">Designed to perform efficiently in Tamil Nadu’s industrial environments.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#fafafa] border-y border-slate-100">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-200 border border-slate-200 shadow-xl">
            {[
              "Trusted Pneumatic Supplies & Spares",
              ...
              <div key={idx} className="bg-white p-16 flex flex-col items-center group transition-all text-center">
                <ShieldCheck className="w-10 h-10 text-slate-200 group-hover:text-blue-600 transition-colors mb-8 stroke-[1px]" />
      ...
      <section className="py-40 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
          ...
          <p className="text-2xl font-['Poppins'] font-light mb-10 uppercase tracking-[0.4em] opacity-60 italic leading-snug">Looking for a dependable Durlon Rock Drill Hose Supplier?</p>
