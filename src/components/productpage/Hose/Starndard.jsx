    ...
    <div className="bg-white font-['Inter'] text-slate-900 overflow-x-hidden">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="flex flex-col sm:flex-row gap-6 mt-16">
                <button className="px-12 py-5 bg-slate-900 text-white font-['Poppins'] font-bold uppercase text-[11px] tracking-[0.2em] hover:bg-red-600 transition-all shadow-xl active:scale-95 flex items-center justify-center gap-3">
                  Bulk Supply Quote <ArrowRight className="w-4 h-4" />
                </button>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
               <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-[0_50px_100px_-20px_rgba(0,0,0,0.12)] border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                  ...
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[80%] bg-white/70 backdrop-blur-md border border-white/40 py-4 px-6 text-center shadow-lg">
                     <span className="text-[10px] font-black uppercase tracking-[0.3em] text-red-600 block mb-1">Standard Series</span>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-8">
              ...
              <div className="flex items-center gap-6 p-8 bg-[#fafafa] border border-slate-100 max-w-2xl shadow-sm">
                ...
                <p className="text-slate-600 text-lg font-bold uppercase tracking-tight leading-tight">
                  Sri Kumar Drill Rods supplies bulk quantities across Tamil Nadu with ready stock availability and quick dispatch support.
                </p>
              </div>
            </div>
            <div className="lg:col-span-4 grid grid-cols-2 gap-4">
               ...
               <div className="bg-[#fafafa] p-8 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100 mt-6">
                  <Wind className="text-slate-900 mb-3 w-8 h-8" />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6">
          <div className="mb-20 text-center">
            ...
            <p className="text-slate-400 font-bold uppercase tracking-[0.4em] text-[10px]">Built for Industrial Rigidity and Flow</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            <div className="lg:w-7/12 flex flex-col gap-6">
              <div className="flex-grow bg-white border border-slate-200 shadow-sm relative group overflow-hidden flex flex-col items-center justify-center p-12">
                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.02] text-[18rem] font-['Poppins'] font-black pointer-events-none select-none text-red-600 uppercase">HOSE</div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          ...
          <p className="mt-20 text-center text-slate-400 italic text-lg font-medium">Designed for reliable performance in Tamil Nadu’s heavy-duty drilling environments.</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-200 border border-slate-200 shadow-xl">
            {[
              ...
              <div key={reason} className="bg-white p-16 flex flex-col items-center group transition-all text-center">
                <Award className="w-10 h-10 text-slate-200 group-hover:text-red-600 transition-colors mb-8 mx-auto" />
                <p className="font-['Poppins'] font-bold uppercase text-[10px] tracking-[0.2em] text-slate-800">{reason}</p>
              </div>
            ))}
          </div>
          <p className="mt-16 text-slate-400 italic text-xl max-w-4xl mx-auto">We focus on supplying high-performance drilling hoses that ensure operational efficiency and reduced downtime.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white text-center">
        <div className="max-w-screen-2xl mx-auto px-6">
          <h2 className="text-4xl lg:text-[3rem] font-['Poppins'] font-black uppercase italic mb-16 tracking-tighter text-slate-900 text-center uppercase">Supplying Across <span className="text-red-600">Tamil Nadu</span></h2>
          ...
          <p className="mt-10 text-slate-400 font-bold uppercase tracking-widest text-[10px]">All major mining and quarry regions in Tamil Nadu</p>
        </div>
      </section>
      ...
      <section className="py-40 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
          <h2 className="text-6xl lg:text-[5.5rem] font-['Poppins'] font-black uppercase italic tracking-tighter mb-8 leading-none">Bulk Supply <br /> & Orders</h2>
          <div className="w-20 h-[1px] bg-red-600 mx-auto mb-16"></div>
          <p className="text-2xl font-['Poppins'] font-bold mb-10 uppercase tracking-[0.4em] opacity-60 italic">Looking for a reliable Standard Rock Drill Hose supplier in Tamil Nadu?</p>
