  ...
  return (
    <div className="bg-white font-['Inter'] text-slate-900 overflow-x-hidden antialiased">
      ...
      <head>
        ...
        <meta name="description" content="Buy high-quality Connect Rod for Atlas Copco VT4 Compressor in Tamil Nadu. Sri Kumar Drill Rods supplies durable compressor spare parts at B2B pricing." />
        <link rel="canonical" href="https://srikumardrillrods.com/atlas-copco-vt4-connect-rod-tamil-nadu" />
      </head>
            ...
            <div className="lg:col-span-7">
              ...
              <div className="max-w-xl space-y-10">
                <p className="text-slate-500 text-lg lg:text-xl leading-relaxed border-l border-slate-200 pl-8 font-light italic">
                  Sri Kumar Drill Rods supplies high-quality Connect Rod for Atlas Copco VT 4 Compressor, engineered for reliable performance and long service life in industrial air compressor applications. As a trusted compressor spare parts supplier in Tamil Nadu, we provide precision-fit connecting rods at competitive B2B pricing for mining contractors, quarry operators, construction companies, and industrial units.
                </p>
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
               <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-2xl border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                  ...
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[85%] bg-white/90 backdrop-blur-md border border-white/40 py-5 px-6 text-center shadow-lg">
                     <span className="text-[9px] font-semibold uppercase tracking-[0.4em] text-blue-600 block mb-1">Crankshaft Interface</span>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-4 grid grid-cols-1 gap-6">
               <div className="bg-[#fafafa] p-10 flex flex-col items-center justify-center text-center border border-slate-100 hover:shadow-xl transition-all group">
                  <Filter className="text-blue-600 mb-4 w-10 h-10 stroke-[1px] group-hover:scale-110 transition-transform" />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
               <h2 className="text-4xl lg:text-[4rem] font-['Poppins'] font-light text-white uppercase italic tracking-tighter leading-none mb-8">
                 Component <br /> <span className="text-blue-600 font-semibold">Showcase</span>
               </h2>
            ...
            <div className="lg:w-1/2 w-full">
               <div className="relative aspect-square md:aspect-video bg-black/40 border border-white/10 overflow-hidden rounded-xl group shadow-2xl">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6">
          <div className="mb-20 text-center">
            ...
            <p className="text-slate-400 font-semibold uppercase tracking-[0.4em] text-[10px]">Precision-Engineered for High-Pressure Loads</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              "Precision-engineered for Atlas Copco VT 4 Compressor",
              "High tensile strength material",
              "Excellent load-bearing capacity",
              "Wear-resistant and durable design",
              "Ensures smooth compressor operation",
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { label: "Material", val: "High-strength forged steel", detail: "Forged" },
                    { label: "Performance", val: "High durability & precision", detail: "Verified" },
      ...
      <section className="py-40 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-10 justify-center items-center">
             <button onClick={handleCall} className="w-full sm:w-auto px-16 py-8 bg-white text-slate-900 font-['Poppins'] font-semibold uppercase text-[10px] tracking-[0.4em] hover:bg-blue-600 hover:text-white transition-all shadow-2xl flex items-center justify-center gap-6 active:scale-95">
