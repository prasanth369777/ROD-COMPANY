...
export default function FilterProductPage() {
  ...
  useEffect(() => {
    ...
    // Auto-slideshow logic for the visual inventory section
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-4 grid grid-cols-2 gap-4">
               <div className="bg-[#fafafa] p-10 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100">
                  <Filter className="text-red-600 mb-3 w-8 h-8 stroke-[1px]" />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
               ...
               <p className="text-slate-500 text-lg font-light leading-relaxed mb-12 max-w-md">
                 Explore our high-precision VT4 filter catalog through our automated showcase. We prioritize visual transparency for all our industrial spares.
               </p>
        ...
        <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-10 justify-center items-center">
             <button className="w-full sm:w-auto px-16 py-8 bg-white text-slate-900 font-['Poppins'] font-semibold uppercase text-[10px] tracking-[0.4em] hover:bg-red-600 hover:text-white transition-all shadow-2xl flex items-center gap-6 active:scale-95">
                <Phone size={18} strokeWidth={1} /> Call Technical Team
             </button>
