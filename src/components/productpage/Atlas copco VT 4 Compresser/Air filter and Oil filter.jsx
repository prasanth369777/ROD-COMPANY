  ...
  import { Icon } from "@iconify/react"; // 🔹 Using Iconify for professional stroke icons
            ...
            <div className="grid lg:grid-cols-12 gap-16 items-center">
              <div className="lg:col-span-7">
                ...
                <div className="flex items-start gap-6 mb-12">
                  <div className="pt-1">
                      <Icon icon="ph:shield-check-light" className="text-red-600 w-7 h-7" />
                  </div>
                ...
                <div className="flex flex-col sm:flex-row gap-6 mt-16">
                  <button 
                    ...
                    className="px-12 py-5 bg-slate-900 text-white font-['Poppins'] font-semibold uppercase text-[10px] tracking-[0.3em] hover:bg-red-600 transition-all shadow-xl active:scale-95 flex items-center justify-center gap-3"
                  >
                    WhatsApp Pricing <Icon icon="ph:whatsapp-logo-light" width="16" />
                  </button>
                  <button 
                    onClick={handleCall}
                  ...
                  >
                    Call Support <Icon icon="ph:phone-call-light" width="16" />
                  </button>
                </div>
              </div>
                ...
                <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-2xl border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                    <div className="absolute top-6 right-6 z-20">
                      <div className="p-3 bg-red-600 text-white rounded-full shadow-lg hover:scale-110 transition-transform cursor-pointer">
                          <Icon icon="ph:magnifying-glass-plus-light" width="18" />
                      </div>
                    </div>
                    <div className="w-full h-full flex items-center justify-center relative z-10 transition-transform duration-1000 group-hover:scale-105">
                      <img src={activeImg} className="max-h-full w-auto object-contain filter drop-shadow-2xl grayscale group-hover:grayscale-0 transition-all duration-700" alt="VT4 Compressor Filters" />
                    </div>
                    <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[85%] bg-white/90 backdrop-blur-md border border-white/40 py-5 px-6 text-center shadow-lg">
                      ...
                      <h3 className="text-sm font-['Poppins'] font-light uppercase text-slate-800 tracking-widest leading-none">VT4 Filtration Kit</h3>
                    </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-screen-2xl mx-auto px-6">
            <div className="grid lg:grid-cols-12 gap-16 items-center">
              <div className="lg:col-span-8">
                <h2 className="text-4xl lg:text-[3.5rem] font-['Poppins'] font-light uppercase italic tracking-tighter mb-8 text-slate-900 leading-[1]">
              ...
              <div className="lg:col-span-4 grid grid-cols-2 gap-4">
                <div className="bg-[#fafafa] p-10 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100">
                    <Icon icon="ph:filter-light" className="text-red-600 mb-3 w-9 h-9" />
                    <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400">Pure Intake</span>
                </div>
                <div className="bg-[#fafafa] p-10 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100 mt-6">
                    <Icon icon="ph:lightning-light" className="text-slate-900 mb-3 w-9 h-9" />
                    <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400">Low Wear</span>
                </div>
              </div>
            </div>
          </div>
...
<section className="py-32 bg-slate-950 overflow-hidden relative">
  ...
  {/* 🔹 HERO1 BACKGROUND OVERLAY */}
  <div className="absolute inset-0 opacity-40 pointer-events-none">
      <img 
        src={hero} // Ensure 'hero' points to "../../../assests/Hero1.webp" as defined in your imports
    ...
    <div className="flex flex-col lg:flex-row items-center gap-16">
      <div className="lg:w-full">
         <h2 className="text-4xl lg:text-[4rem] font-['Poppins'] font-light text-white uppercase italic tracking-tighter leading-none mb-8">
           Visual <br /> <span className="text-red-600 font-semibold">Inventory Registry</span>
         </h2>
        ...
        <section className="py-24 bg-white">
          <div className="max-w-screen-2xl mx-auto px-6">
            <div className="mb-20 text-center">
              <h2 className="text-5xl lg:text-[4.5rem] font-['Poppins'] font-light uppercase italic tracking-tighter leading-none mb-4">
                Key Features
              </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <div key={feature} className="p-10 bg-[#fafafa] border border-slate-100 hover:bg-white hover:shadow-2xl transition-all group duration-500">
                  <Icon icon="ph:check-circle-light" className="text-slate-200 group-hover:text-red-600 mb-8 w-11 h-11 transition-colors" />
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-stretch">
              ...
              <div className="lg:w-5/12 bg-white p-10 lg:p-16 border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-between">
                <div className="relative z-10">
                  <div className="flex items-center gap-4 mb-12">
                    ...
                    <h2 className="text-4xl lg:text-[2.8rem] font-['Poppins'] font-light uppercase italic tracking-tighter leading-[1]">Technical <br /> <span className="font-semibold">Details</span></h2>
                  </div>
              ...
              <div className="lg:w-7/12 flex flex-col gap-6">
                <div className="flex-grow bg-white border border-slate-200 shadow-sm relative group overflow-hidden flex flex-col items-center justify-center p-12">
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.02] text-[18rem] font-['Poppins'] font-semibold pointer-events-none select-none text-red-600 uppercase">FILTER</div>
        ...
        <section className="py-24 bg-[#fafafa] border-y border-slate-100">
          <div className="max-w-screen-2xl mx-auto px-6 text-center">
            <h2 className="text-5xl lg:text-[3.5rem] font-['Poppins'] font-light uppercase italic tracking-tighter mb-24 leading-none">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-200 border border-slate-200 shadow-xl text-center">
              {[
                ...
                <div key={idx} className="bg-white p-16 flex flex-col items-center group transition-all">
                  <Icon icon={reason.icon} className="w-11 h-11 text-slate-200 group-hover:text-red-600 transition-colors mb-8" />
                  <p className="font-['Poppins'] font-semibold uppercase text-[10px] tracking-[0.3em] text-slate-800">{reason.text}</p>
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-9 gap-4 text-center">
              {["Coimbatore", "Salem", "Chennai", "Madurai", "Trichy", "Erode", "Namakkal", "Tirunelveli", "Hosur"].map((city) => (
                <div key={city} className="py-8 border border-slate-100 flex flex-col items-center gap-3 group hover:border-red-600 transition-all bg-[#fafafa]">
                  <Icon icon="ph:map-pin-line-light" className="w-5 h-5 text-slate-300 group-hover:text-red-600" /> 
        ...
        <section className="py-40 relative overflow-hidden bg-slate-900">
          ...
          <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
            <h2 className="text-6xl lg:text-[5rem] font-['Poppins'] font-light uppercase italic tracking-tighter mb-8 leading-none text-white">Bulk Orders <br /> <span className="font-semibold text-red-600">& Enquiry</span></h2>
            <div className="w-20 h-[1px] bg-red-600 mx-auto mb-16"></div>
            <p className="text-2xl font-['Poppins'] font-light mb-10 uppercase tracking-[0.4em] opacity-60 italic">Looking for a dependable Atlas Copco VT 4 Compressor Filter Supplier?</p>
            ...
            <div className="flex flex-col sm:flex-row gap-10 justify-center items-center">
              <button 
                onClick={handleCall}
                className="w-full sm:w-auto px-16 py-8 bg-white text-slate-900 font-['Poppins'] font-semibold uppercase text-[10px] tracking-[0.4em] hover:bg-red-600 hover:text-white transition-all shadow-2xl flex items-center gap-6 active:scale-95"
              >
                  <Icon icon="ph:phone-call-light" width="22" /> Call Technical Team
              </button>
              <button 
                onClick={() => window.open(whatsappLink, '_blank')}
                className="w-full sm:w-auto px-16 py-8 border border-white/20 text-white font-['Poppins'] font-semibold uppercase text-[10px] tracking-[0.4em] hover:bg-white hover:text-slate-900 transition-all flex items-center gap-6"
              >
                  Contact via WhatsApp <Icon icon="ph:whatsapp-logo-light" width="22" />
              </button>
            </div>
          </div>
        </section>
