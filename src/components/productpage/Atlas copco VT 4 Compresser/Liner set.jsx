...
import img1 from "../../../assests/productimg/Liner set/1.webp";
import img2 from "../../../assests/productimg/Liner set/2.webp"; // Using available assets
import img3 from "../../../assests/productimg/Liner set/3.webp"; 
import img4 from "../../../assests/productimg/Liner set/4.webp";
import img5 from "../../../assests/productimg/Liner set/5.webp";

export default function LinerSetProductPage() {
  ...
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hi Sri Kumar Drill Rods, I am inquiring about the Atlas Copco VT 4 Liner Set. Please provide B2B pricing.`;
  ...
  return (
    <div className="bg-white font-['Inter'] text-slate-900 overflow-x-hidden antialiased">
      {/* SEO META DATA */}
      <head>
        <title>Atlas Copco VT 4 Liner Set Supplier Tamil Nadu | Sri Kumar Drill Rods</title>
        <meta name="description" content="Buy Atlas Copco VT 4 Compressor Liner Set in Tamil Nadu. Sri Kumar Drill Rods supplies durable compressor spare parts for mining and industrial use." />
        <link rel="canonical" href="https://srikumardrillrods.com/atlas-copco-vt4-liner-set-tamil-nadu" />
      </head>
            ...
            <div className="lg:col-span-7">
              <div className="flex items-center gap-4 mb-10">
                ...
                <span className="text-slate-400 font-['Poppins'] font-semibold tracking-[0.4em] uppercase text-[10px]">
                  Atlas Copco VT 4 Series Spares
                </span>
              </div>
              ...
              <div className="flex items-start gap-6 mb-12">
                 <div className="pt-1">
                    <ShieldCheck className="text-blue-600 w-6 h-6 stroke-[1px]" />
                 </div>
                 <h2 className="text-xl lg:text-2xl font-['Poppins'] font-light text-slate-700 leading-tight tracking-wide">
                    Atlas Copco VT 4 Compressor Liner Set Supplier in Tamil Nadu
                 </h2>
              </div>

              <div className="max-w-xl space-y-10">
                <p className="text-slate-500 text-lg lg:text-xl leading-relaxed border-l border-slate-200 pl-8 font-light italic">
                  Sri Kumar Drill Rods supplies high-quality Liner Set for Atlas Copco VT 4 Compressor, suitable for mining, quarry, and industrial air compression applications. We provide reliable compressor spare parts at competitive B2B pricing across Tamil Nadu.
                </p>
                ...
                <div className="pl-8 flex items-center gap-4 text-slate-400">
                   ...
                   <p className="italic text-base lg:text-lg leading-relaxed font-light">
                    Our liner sets are designed to ensure smooth piston movement, reduced wear, and consistent compressor performance in demanding working conditions.
                   </p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 mt-16">
                <button 
                  ...
                  className="px-12 py-5 bg-slate-900 text-white font-['Poppins'] font-semibold uppercase text-[10px] tracking-[0.3em] hover:bg-blue-600 transition-all shadow-xl active:scale-95 flex items-center justify-center gap-3"
                >
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
               <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-2xl border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                  <div className="w-full h-full flex items-center justify-center relative z-10 transition-transform duration-1000 group-hover:scale-105">
                     <img src={activeImg} className="max-h-full w-auto object-contain filter drop-shadow-2xl transition-all duration-700" alt="Atlas Copco Liner Set Asset" />
                  </div>
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[85%] bg-white/90 backdrop-blur-md border border-white/40 py-5 px-6 text-center shadow-lg">
                     <span className="text-[9px] font-semibold uppercase tracking-[0.4em] text-blue-600 block mb-1">Genuine OEM Specs</span>
                     <h3 className="text-sm font-['Poppins'] font-light uppercase text-slate-800 tracking-widest leading-none">VT 4 Series Liner</h3>
                  </div>
               </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-8">
              ...
              <p className="text-xl lg:text-2xl text-slate-500 leading-relaxed font-light max-w-3xl mb-12">
                The Liner Set is a critical internal component of the Atlas Copco VT 4 Compressor. It helps maintain compression efficiency by providing proper cylinder sealing and smooth operation. Manufactured using durable industrial-grade materials, the liner set supports long service life and stable performance.
              </p>
            ...
            <div className="lg:col-span-4 grid grid-cols-2 gap-4">
               <div className="bg-[#fafafa] p-10 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100">
                  <Layers className="text-blue-600 mb-3 w-8 h-8 stroke-[1px]" />
                  <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 mt-2">Perfect Seal</span>
               </div>
               <div className="bg-[#fafafa] p-10 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100 mt-6">
                  ...
                  <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 mt-2">Stable Duty</span>
               </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 bg-slate-950 overflow-hidden relative">
        <div className="absolute top-0 right-0 p-20 opacity-10 pointer-events-none"></div>
        <div className="max-w-screen-2xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
               ...
               <p className="text-slate-400 text-lg font-light leading-relaxed mb-12 max-w-md">
                 Explore our high-precision cylinder liner catalog through our automated showcase. We prioritize visual transparency for all our industrial spares.
               </p>
               ...
               <div className="relative aspect-square md:aspect-video bg-black/40 border border-white/5 overflow-hidden rounded-xl group shadow-2xl">
                  {productImages.map((img, i) => (
                    <img 
                      ...
                      alt="Liner Set Slideshow" 
                    />
                  ))}
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-transparent to-transparent"></div>
                  <div className="absolute bottom-10 left-10 text-white">
                      <p className="text-[10px] font-bold uppercase tracking-[0.5em] text-blue-600 mb-2">Live Registry</p>
                      <h4 className="text-xl font-light tracking-widest uppercase italic">VT4 Cylinder Liners</h4>
                  </div>
               </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6">
          <div className="mb-20 text-center">
            ...
            <p className="text-slate-400 font-semibold uppercase tracking-[0.4em] text-[10px]">Precision Components for High Performance</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-stretch">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { label: "Usage Type", val: "Replacement Spare Part", detail: "Critical" },
                    { label: "Application", val: "Industrial Air Compressors", detail: "Universal" },
                    { label: "Material", val: "High-strength industrial alloy", detail: "Alloy" },
                    { label: "Performance", val: "Consistent compression sealing", detail: "Verified" },
            ...
            <div className="lg:w-7/12 flex flex-col gap-6">
              <div className="flex-grow bg-white border border-slate-200 shadow-sm relative group overflow-hidden flex flex-col items-center justify-center p-12">
                <img src={activeImg} className="max-h-[350px] w-auto object-contain transition-all duration-700 group-hover:scale-105" alt="Atlas Copco Liner Set Showcase" />
              </div>
              <div className="grid grid-cols-5 gap-4">
                {productImages.map((img, index) => (
                  <button 
                    ...
                    className={`aspect-square bg-white border transition-all duration-300 overflow-hidden p-2 ${activeImg === img ? 'border-blue-600 shadow-xl scale-95' : 'border-slate-200 opacity-60 hover:opacity-100'}`}
                  >
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          <h2 className="text-5xl lg:text-[4.5rem] font-['Poppins'] font-semibold uppercase italic tracking-tighter mb-20 leading-[0.8]">
            Industry <span className="text-blue-600 font-normal">Applications</span>
          </h2>
          ...
          <p className="mt-20 text-center text-slate-400 italic text-lg font-light tracking-wide">Designed to perform efficiently in Tamil Nadu’s industrial and mining environments.</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-200 border border-slate-200 shadow-xl">
            {[
              ...
              <div key={idx} className="bg-white p-16 flex flex-col items-center group transition-all text-center">
                <Award className="w-10 h-10 text-slate-200 group-hover:text-blue-600 transition-colors mb-8 stroke-[1px]" />
                <p className="font-['Poppins'] font-semibold uppercase text-[10px] tracking-[0.3em] text-slate-800">{reason}</p>
              </div>
            ))}
          </div>
          <p className="mt-16 text-slate-400 italic text-xl font-light">We supply durable compressor spare parts that improve equipment performance and reduce maintenance downtime.</p>
        </div>
      </section>
      ...
      <section className="py-40 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
          <h2 className="text-6xl lg:text-[5rem] font-['Poppins'] font-light uppercase italic tracking-tighter mb-8 leading-none">Bulk Orders <br /> <span className="font-semibold text-blue-600">& Enquiry</span></h2>
          <div className="w-20 h-[1px] bg-blue-600 mx-auto mb-16"></div>
          <p className="text-2xl font-['Poppins'] font-light mb-10 uppercase tracking-[0.4em] opacity-60 italic leading-snug">Looking for a dependable Atlas Copco VT 4 Compressor Liner Set Supplier?</p>
          ...
          <div className="flex flex-col sm:flex-row gap-10 justify-center items-center">
            <button 
              onClick={handleCall}
              className="w-full sm:w-auto px-16 py-8 bg-white text-slate-900 font-['Poppins'] font-semibold uppercase text-[10px] tracking-[0.4em] hover:bg-blue-600 hover:text-white transition-all shadow-2xl flex items-center justify-center gap-6 active:scale-95"
            >
