...
// 🔹 UPDATED ASSETS: Pointing to the specific Liner Set directory
import img1 from "../../../assests/productimg/Liner set/1.webp";
import img2 from "../../../assests/productimg/Liner set/1.webp"; // Using available set images
import img3 from "../../../assests/productimg/Liner set/1.webp";
import img4 from "../../../assests/productimg/Liner set/1.webp";
import img5 from "../../../assests/productimg/Liner set/1.webp";
    ...
    <div className="bg-white font-['Inter'] text-slate-900 overflow-x-hidden">
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
               <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-2xl border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                  ...
                  <div className="w-full h-full flex items-center justify-center relative z-10 transition-transform duration-1000 group-hover:scale-105">
                     <img src={activeImg} className="max-h-full w-auto object-contain filter drop-shadow-2xl grayscale group-hover:grayscale-0 transition-all duration-700" alt="Atlas Copco Liner Set Asset" />
                  </div>
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[85%] bg-white/90 backdrop-blur-md border border-white/40 py-5 px-6 text-center shadow-lg">
                     <span className="text-[9px] font-semibold uppercase tracking-[0.4em] text-red-600 block mb-1">Genuine OEM Specs</span>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-4 grid grid-cols-2 gap-4">
               <div className="bg-[#fafafa] p-10 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100">
                  <Layers className="text-red-600 mb-3 w-8 h-8 stroke-[1px]" />
                  <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400">Perfect Seal</span>
               </div>
               <div className="bg-[#fafafa] p-10 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100 mt-6">
                  ...
                  <span className="text-[10px] font-semibold uppercase tracking-widest text-slate-400">Stable Duty</span>
               </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
               ...
               <div className="flex items-center gap-4">
                  ...
                  <div className="text-slate-600 font-medium uppercase tracking-[0.4em] text-[9px]">OES Component Catalog</div>
               </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            <div className="lg:w-5/12 bg-white p-10 lg:p-16 border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-between">
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-12">
                  ...
                  <h2 className="text-4xl lg:text-[2.8rem] font-['Poppins'] font-semibold uppercase italic tracking-tighter leading-[1]">Technical <br /> <span className="font-semibold text-slate-300">Details</span></h2>
                </div>
                <div className="space-y-2">
                  {[
                    { label: "Compatible With", val: "Atlas Copco VT 4 Compressor", detail: "Exact OEM Fit" },
                    { label: "Usage Type", val: "Replacement Spare Part", detail: "Critical Component" },
                    { label: "Application", val: "Mining, Quarry, Industrial Air", detail: "High Duty" },
                    { label: "Material", val: "High-strength industrial alloy", detail: "Forged Steel" },
                    { label: "Availability", val: "Standard models (Custom on request)", detail: "Stock Ready" }
                  ].map((spec, i) => (
            ...
            <div className="lg:w-7/12 flex flex-col gap-6">
              <div className="flex-grow bg-white border border-slate-200 shadow-sm relative group overflow-hidden flex flex-col items-center justify-center p-12">
                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.02] text-[18rem] font-['Poppins'] font-semibold pointer-events-none select-none text-red-600 uppercase">LINER</div>
                 <img src={activeImg} className="max-h-[350px] w-auto object-contain transition-all duration-700 group-hover:scale-105" alt="VT 4 Liner Set Showcase" />
              </div>
      ...
      <section className="py-24 bg-white text-center border-b border-slate-50">
        <div className="max-w-screen-2xl mx-auto px-6">
          ...
          <p className="mt-10 text-slate-400 font-semibold uppercase tracking-[0.4em] text-[10px]">All Major Industrial & Mining Zones</p>
        </div>
      </section>
      ...
      <section className="py-40 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
          ...
          <p className="text-2xl font-['Poppins'] font-light mb-10 uppercase tracking-[0.4em] opacity-60 italic leading-snug">Looking for a reliable Atlas Copco VT 4 Compressor Liner Set Supplier?</p>
