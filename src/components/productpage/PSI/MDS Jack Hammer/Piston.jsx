...
import img2 from "../../../../assests/productimg/Piston/2.webp";
import img3 from "../../../../assests/productimg/Piston/3.webp";
import img4 from "../../../../assests/productimg/Piston/4.webp";
import img5 from "../../../../assests/productimg/Piston/5.webp";

const productImages = [img1, img2, img3, img4, img5];

export default function PistonProductPage() {
  ...
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hi Sri Kumar Drill Rods, I am inquiring about the PSI/MDS Jack Hammer Piston. Please provide B2B pricing and delivery timelines.`;
  ...
  useEffect(() => {
    ...
    // Slideshow transition logic based on both active image index and slideIndex state
  ...
  return (
    <div className="bg-white font-['Inter'] text-slate-900 overflow-x-hidden antialiased">
      {/* SEO META DATA */}
      <head>
        <title>PSI MDS Jack Hammer Piston Supplier Tamil Nadu | Sri Kumar Drill Rods</title>
        <meta name="description" content="Buy PSI and MDS Jack Hammer Piston in Tamil Nadu at competitive prices. Trusted B2B supplier for mining and quarry drilling spare parts." />
        <link rel="canonical" href="https://srikumardrillrods.com/psi-mds-jack-hammer-piston-tamil-nadu" />
      </head>
            ...
            <div className="lg:col-span-7">
              ...
              <div className="flex items-start gap-6 mb-12">
                 ...
                 <h2 className="text-xl lg:text-2xl font-['Poppins'] font-medium text-slate-700 leading-tight">
                    Jack Hammer Piston Supplier in Tamil Nadu
                 </h2>
              </div>

              <div className="max-w-xl space-y-10">
                <p className="text-slate-500 text-lg lg:text-xl leading-relaxed border-l-2 border-slate-200 pl-8 font-light italic">
                  Sri Kumar Drill Rods supplies high-quality Piston for PSI / MDS Jack Hammers for mining, quarry, and construction applications across Tamil Nadu. We provide reliable spare parts at competitive prices with bulk supply support.
                </p>
                ...
                <div className="pl-8 flex items-center gap-4 text-slate-400">
                   <p className="italic text-base lg:text-lg leading-relaxed font-light">
                    Precision engineered to convert compressed air into maximum impact force.
                   </p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 mt-16">
                ...
                <button onClick={handleCall} className="px-12 py-5 bg-slate-900 text-white font-['Poppins'] font-bold uppercase text-[11px] tracking-[0.2em] hover:bg-blue-600 transition-all shadow-xl active:scale-95 flex items-center justify-center gap-3">
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
               <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-2xl border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                  ...
                  <div className="w-full h-full flex items-center justify-center relative z-10 transition-transform duration-700 group-hover:scale-105">
                     <img src={activeImg} className="max-h-full w-auto object-contain filter drop-shadow-xl" alt="Piston Main Asset" />
                  </div>
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[80%] bg-white/70 backdrop-blur-md border border-white/40 py-4 px-6 text-center shadow-lg">
                     <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 block mb-1">Energy Transfer King</span>
                     <h3 className="text-sm font-['Poppins'] font-bold uppercase text-slate-800 tracking-tighter italic leading-none">MDS / PSI Series Piston</h3>
                  </div>
               </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-8">
              ...
              <p className="text-xl lg:text-2xl text-slate-500 leading-relaxed font-normal max-w-3xl mb-12">
                The Piston is a key internal component in PSI and MDS Jack Hammers. It converts compressed air into impact force for effective rock drilling. Our supplied pistons are made from durable industrial-grade material to ensure consistent performance and longer service life.
              </p>
              <div className="flex items-center gap-6 p-8 bg-[#fafafa] border border-slate-100 max-w-2xl shadow-sm">
                ...
                <p className="text-slate-600 text-lg font-medium tracking-tight leading-tight">
                  Providing durable industrial-grade pistons for the most demanding Tamil Nadu job sites.
                </p>
              </div>
            </div>
            <div className="lg:col-span-4 grid grid-cols-1 gap-6">
               <div className="bg-[#fafafa] p-10 flex flex-col items-center justify-center text-center border border-slate-100 hover:shadow-lg transition-all">
                  <Zap className="text-blue-600 mb-3 w-8 h-8 stroke-[1px]" />
                  <span className="text-[10px] font-medium uppercase tracking-widest text-slate-400 mt-2">High Force</span>
               </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6">
          <div className="mb-20 text-center">
            ...
            <p className="text-slate-400 font-medium uppercase tracking-[0.4em] text-[10px]">Precision Built for Constant Impact</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              "Suitable for PSI / MDS Jack Hammers",
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            <div className="lg:w-5/12 bg-white p-10 lg:p-16 border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-between">
              <div className="relative z-10">
                <h2 className="text-4xl lg:text-[3rem] font-['Poppins'] font-semibold uppercase italic tracking-tighter leading-[0.9] mb-12">Technical <br /> <span className="font-light text-slate-300">Specifications</span></h2>
                <div className="space-y-2">
                  {[
                    { label: "Compatible Models", val: "PSI / MDS Jack Hammers", detail: "Universal" },
                    { label: "Material", val: "Industrial Grade Steel", detail: "High Strength" },
                    { label: "Function", val: "Force Conversion", detail: "Impact" },
                    { label: "Service Life", val: "Extended Duty", detail: "Long Life" },
                    { label: "Supply", val: "Bulk & Individual", detail: "In Stock" }
                  ].map((spec, i) => (
            ...
            <div className="lg:w-7/12 flex flex-col gap-6">
              <div className="flex-grow bg-white border border-slate-200 shadow-sm relative group overflow-hidden flex flex-col items-center justify-center p-12">
                 <img src={activeImg} className="max-h-[350px] w-auto object-contain filter drop-shadow-2xl transition-all duration-700" alt="Piston Showcase" />
              </div>
      ...
      <section className="py-40 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
          ...
          <p className="text-2xl font-['Poppins'] font-light mb-10 uppercase tracking-[0.4em] opacity-60 italic leading-snug">Looking for a reliable PSI / MDS Jack Hammer Piston Supplier?</p>
