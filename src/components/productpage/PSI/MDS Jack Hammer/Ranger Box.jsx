...
import img1 from "../../../../assests/productimg/Ranger Box/1.webp";
import img2 from "../../../../assests/productimg/Ranger Box/2.webp";
import img3 from "../../../../assests/productimg/Ranger Box/3.webp";
import img4 from "../../../../assests/productimg/Ranger Box/4.webp";
import img5 from "../../../../assests/productimg/Ranger Box/5.webp";
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
               <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-2xl border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                  ...
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[80%] bg-white/70 backdrop-blur-md border border-white/40 py-4 px-6 text-center shadow-lg">
                     <span className="text-[10px] font-black uppercase tracking-[0.3em] text-orange-600 block mb-1">Energy Transfer King</span>
