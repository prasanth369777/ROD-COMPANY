...
export default function RangerBoxProductPage() {
  ...
  return (
    <div className="bg-white font-['Inter'] text-slate-900 overflow-x-hidden">
      {/* SEO META DATA */}
      <head>
        <title>Ranger Box PSI MDS Jack Hammer Supplier TN | Sri Kumar Drill Rods</title>
        <meta name="description" content="Buy Ranger Box for PSI and MDS Jack Hammer in Tamil Nadu. Trusted B2B supplier of durable jack hammer spare parts at competitive prices." />
        <link rel="canonical" href="https://srikumardrillrods.com/ranger-box-psi-mds-jack-hammer-tamil-nadu" />
      </head>
            ...
            <div className="lg:col-span-7">
              ...
              <div className="flex items-start gap-6 mb-12">
                 ...
                 <h2 className="text-xl lg:text-2xl font-['Poppins'] font-medium text-slate-700 leading-tight">
                   Heavy-Duty Ranger Box Supplier in Tamil Nadu
                 </h2>
              </div>

              <div className="max-w-xl space-y-10">
                <p className="text-slate-500 text-lg lg:text-xl leading-relaxed border-l-2 border-slate-200 pl-8 font-medium italic">
                  Sri Kumar Drill Rods supplies high-quality Ranger Box for PSI / MDS Jack Hammers, designed for stable performance and long service life in demanding drilling environments. As a trusted Jack Hammer spare parts supplier in Tamil Nadu, we provide reliable components at competitive B2B pricing for mining contractors, quarry operators, and construction companies.
                </p>
                <div className="pl-8 flex items-center gap-4 text-slate-400">
                   ...
                   <p className="italic text-base lg:text-lg leading-relaxed font-medium">
                    Our Ranger Box ensures smooth internal operation and structural durability under continuous heavy-duty usage.
                   </p>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
               <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-2xl border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                  ...
                  <div className="w-full h-full flex items-center justify-center relative z-10 transition-transform duration-700 group-hover:scale-105">
                     <img src={activeImg} className="max-h-full w-auto object-contain filter drop-shadow-xl" alt="Ranger Box Asset" />
                  </div>
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[80%] bg-white/70 backdrop-blur-md border border-white/40 py-4 px-6 text-center shadow-lg">
                     <span className="text-[10px] font-black uppercase tracking-[0.3em] text-red-600 block mb-1">Heavy Duty Frame</span>
                     <h3 className="text-sm font-['Poppins'] font-bold uppercase text-slate-800 tracking-tighter italic leading-none">MDS / PSI Ranger Box</h3>
                  </div>
               </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-8">
              ...
              <p className="text-xl lg:text-2xl text-slate-500 leading-relaxed font-normal max-w-3xl mb-12">
                The Ranger Box is a critical structural component used in PSI and MDS Jack Hammers. It supports internal assembly alignment and helps maintain consistent impact performance during rock drilling operations. Manufactured using durable industrial-grade materials, this component ensures reliability in harsh working conditions commonly found in Tamil Nadu’s quarry and mining sectors.
              </p>
              <div className="flex items-center gap-6 p-8 bg-[#fafafa] border border-slate-100 max-w-2xl shadow-sm">
                ...
                <p className="text-slate-600 text-lg font-bold uppercase tracking-tight leading-tight">
                  Sri Kumar Drill Rods maintains ready stock availability for bulk supply and quick dispatch.
                </p>
              </div>
            </div>
            <div className="lg:col-span-4 grid grid-cols-2 gap-4">
               <div className="bg-[#fafafa] p-8 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100">
                  <Box className="text-red-600 mb-3 w-8 h-8" />
                  <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Stable Housing</span>
               </div>
               <div className="bg-[#fafafa] p-8 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100 mt-6">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Impact Grade</span>
               </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6">
          <div className="mb-20 text-center">
            ...
            <p className="text-slate-400 font-bold uppercase tracking-[0.4em] text-[10px]">Forged for Extreme Structural Strength</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              "Precision-fit for PSI / MDS Jack Hammers",
              "High-strength industrial-grade material",
              "Excellent durability under heavy impact",
              "Supports stable hammer performance",
              "Resistant to wear and vibration",
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            <div className="lg:w-5/12 bg-white p-10 lg:p-16 border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-between">
              <div className="relative z-10">
                ...
                <div className="space-y-2">
                  {[
                    { label: "Compatible With", val: "PSI Jack Hammer / MDS Jack Hammer", detail: "Universal" },
                    { label: "Usage Type", val: "Replacement Spare Part", detail: "Maintenance" },
                    { label: "Application", val: "Rock Drilling, Quarrying, Mining", detail: "Heavy Use" },
                    { label: "Material", val: "Heavy-duty industrial steel", detail: "High Grade" },
                    { label: "Availability", val: "Standard fit models", detail: "Ready Stock" }
                  ].map((spec, i) => (
              ...
              <div className="mt-10 p-6 bg-slate-900 text-white text-[10px] font-bold uppercase tracking-widest text-center italic">
                 Custom supply based on specific requirement available.
              </div>
            </div>
            ...
            <div className="lg:w-7/12 flex flex-col gap-6">
              <div className="flex-grow bg-white border border-slate-200 shadow-sm relative group overflow-hidden flex flex-col items-center justify-center p-12">
                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.02] text-[18rem] font-['Poppins'] font-black pointer-events-none select-none">RANGER</div>
                 <img src={activeImg} className="max-h-[350px] w-auto object-contain transition-all duration-700 group-hover:scale-105" alt="Ranger Box Showcase" />
              </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          ...
          <p className="mt-20 text-center text-slate-400 italic text-lg font-medium max-w-3xl mx-auto">Designed to perform reliably in tough geological conditions across Tamil Nadu.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#fafafa] border-y border-slate-100">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          ...
          <p className="mt-16 text-slate-400 italic text-xl">We help reduce downtime by supplying dependable spare parts for continuous drilling operations.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white text-center">
        <div className="max-w-screen-2xl mx-auto px-6">
          ...
          <p className="mt-10 text-slate-400 font-bold uppercase tracking-widest text-[10px]">All Major Quarry & Mining Regions</p>
        </div>
      </section>
      ...
      <section className="py-40 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
          <h2 className="text-6xl lg:text-[5.5rem] font-['Poppins'] font-black uppercase italic tracking-tighter mb-8 leading-none">Bulk Enquiry <br /> & Orders</h2>
          <div className="w-20 h-[1px] bg-red-600 mx-auto mb-16"></div>
          <p className="text-2xl font-['Poppins'] font-bold mb-10 uppercase tracking-[0.4em] opacity-60 italic">Looking for a reliable Ranger Box Supplier in Tamil Nadu?</p>
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
             <button className="w-full sm:w-auto px-20 py-8 bg-white text-slate-900 font-['Poppins'] font-black uppercase text-[11px] tracking-[0.4em] hover:bg-red-600 hover:text-white transition-all shadow-2xl flex items-center gap-6 active:scale-95">
                <Phone size={20} /> Call Technical Expert
             </button>
