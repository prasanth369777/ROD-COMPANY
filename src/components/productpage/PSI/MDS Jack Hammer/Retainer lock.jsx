...
import img1 from "../../../../assests/productimg/Retainer lock/1.webp";
import img2 from "../../../../assests/productimg/Retainer lock/2.webp";
import img3 from "../../../../assests/productimg/Retainer lock/3.webp";
import img4 from "../../../../assests/productimg/Retainer lock/4.webp";
import img5 from "../../../../assests/productimg/Retainer lock/3.webp";

const productImages = [img1, img2, img3, img4, img5];

export default function RetainerLockProductPage() {
  ...
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=Hi Sri Kumar Drill Rods, I am inquiring about the Retainer Lock for PSI/MDS Jack Hammer. Please provide B2B pricing and delivery timelines.`;
  ...
  return (
    <div className="bg-white font-['Inter'] text-slate-900 overflow-x-hidden antialiased">
      {/* SEO META DATA */}
      <head>
        <title>PSI MDS Jack Hammer Retainer Lock Tamil Nadu | Sri Kumar Drill Rods</title>
        <meta name="description" content="Buy PSI and MDS Jack Hammer Retainer Lock in Tamil Nadu. Trusted B2B supplier of durable spare parts for mining and quarry drilling needs." />
        <link rel="canonical" href="https://srikumardrillrods.com/psi-mds-jack-hammer-retainer-lock-tamil-nadu" />
      </head>
            ...
            <div className="lg:col-span-7">
              ...
              <div className="flex items-start gap-6 mb-12">
                 ...
                 <h2 className="text-xl lg:text-2xl font-['Poppins'] font-medium text-slate-700 leading-tight">
                    Durable Jack Hammer Retainer Lock Supplier in Tamil Nadu
                 </h2>
              </div>

              <div className="max-w-xl space-y-10">
                <p className="text-slate-500 text-lg lg:text-xl leading-relaxed border-l-2 border-slate-200 pl-8 font-light italic">
                  Sri Kumar Drill Rods supplies high-quality Retainer Lock for PSI / MDS Jack Hammers, designed to ensure secure tool holding and stable drilling performance. As a trusted Jack Hammer spare parts supplier in Tamil Nadu, we provide precision-fit components at competitive B2B pricing for mining, quarry, and construction applications.
                </p>
                ...
                <div className="pl-8 flex items-center gap-4 text-slate-400">
                   <p className="italic text-base lg:text-lg leading-relaxed font-light">
                    Our retainer locks are engineered to withstand heavy impact and continuous rock drilling operations.
                   </p>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
               <div className="relative w-full max-w-[550px] aspect-square bg-white shadow-2xl border border-slate-100 p-8 lg:p-12 group overflow-hidden">
                  ...
                  <div className="w-full h-full flex items-center justify-center relative z-10 transition-transform duration-700 group-hover:scale-105">
                     <img src={activeImg} className="max-h-full w-auto object-contain filter drop-shadow-xl" alt="Retainer Lock Main View" />
                  </div>
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 w-[80%] bg-white/70 backdrop-blur-md border border-white/40 py-4 px-6 text-center shadow-lg">
                     <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-600 block mb-1">Genuine Parts</span>
                     <h3 className="text-sm font-['Poppins'] font-bold uppercase text-slate-800 tracking-tighter italic leading-none">MDS / PSI Series Lock</h3>
                  </div>
               </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-8">
              ...
              <p className="text-xl lg:text-2xl text-slate-500 leading-relaxed font-normal max-w-3xl mb-12">
                The Retainer Lock is a critical component in PSI / MDS Jack Hammers, responsible for securing the drill tool in position during operation. It helps maintain alignment, reduces vibration issues, and ensures efficient impact transfer. Manufactured using high-strength industrial-grade materials, the retainer lock offers excellent durability and long service life under demanding working conditions.
              </p>
              <div className="flex items-center gap-6 p-8 bg-[#fafafa] border border-slate-100 max-w-2xl shadow-sm">
                ...
                <p className="text-slate-600 text-lg font-medium tracking-tight leading-tight">
                  Sri Kumar Drill Rods maintains ready stock for fast supply across Tamil Nadu.
                </p>
              </div>
            </div>
            <div className="lg:col-span-4 grid grid-cols-2 gap-4">
               <div className="bg-[#fafafa] p-8 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100">
                  <Lock className="text-blue-600 mb-3 w-8 h-8 stroke-[1px]" />
                  <span className="text-[10px] font-medium uppercase tracking-widest text-slate-400 mt-2">Secure Hold</span>
               </div>
               <div className="bg-[#fafafa] p-8 flex flex-col items-center justify-center text-center hover:bg-white hover:shadow-xl transition-all border border-slate-100 mt-6">
                  <Settings className="text-slate-900 mb-3 w-8 h-8 stroke-[1px] animate-spin-slow" />
                  <span className="text-[10px] font-medium uppercase tracking-widest text-slate-400 mt-2">Aligned Performance</span>
               </div>
            </div>
          </div>
        </div>
      ...
      {/* --- SECTION: PRODUCT DYNAMIC CATALOG SLIDER --- */}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
               <h2 className="text-4xl lg:text-[4rem] font-['Poppins'] font-light text-white uppercase italic tracking-tighter leading-none mb-8">
                 Visual <br /> <span className="text-blue-600 font-semibold">Inventory</span>
               </h2>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6">
          <div className="mb-20 text-center">
            ...
            <p className="text-slate-400 font-medium uppercase tracking-[0.4em] text-[10px]">Forged for Secure Tool Retention</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              "Compatible with PSI / MDS Jack Hammers",
              "Secure tool holding performance",
              ...
              <div key={idx} className="p-10 bg-white border border-slate-100 hover:border-blue-600 hover:shadow-2xl transition-all group duration-500">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            <div className="lg:w-5/12 bg-white p-10 lg:p-16 border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-between">
              <div className="relative z-10">
                ...
                <div className="space-y-2">
                  {[
                    { label: "Compatible With", val: "PSI Jack Hammer / MDS Jack Hammer", detail: "Perfect Fit" },
                    { label: "Usage Type", val: "Replacement Spare Part", detail: "Essential" },
                    { label: "Application", val: "Mining, Quarrying, Rock Drilling", detail: "Heavy Duty" },
                    { label: "Material", val: "High-strength industrial-grade steel", detail: "Industrial" },
                    { label: "Performance", val: "Durable under continuous impact", detail: "Reliable" },
            ...
            <div className="lg:w-7/12 flex flex-col gap-6">
              <div className="flex-grow bg-white border border-slate-200 shadow-sm relative group overflow-hidden flex flex-col items-center justify-center p-12">
                 <img src={activeImg} className="max-h-[350px] w-auto object-contain transition-all duration-700 group-hover:scale-105" alt="Retainer Lock Gallery View" />
              </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          <h2 className="text-5xl lg:text-[4rem] font-['Poppins'] font-semibold uppercase italic tracking-tighter mb-20 leading-[0.8]">
            Spare <span className="text-blue-600 font-semibold">Applications</span>
          </h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
            {["Granite Quarry Operations", "Blue Metal Quarry Drilling", "Mining Projects", "Construction Rock Breaking"].map((app, i) => (
              <div key={app} className="group p-10 bg-[#fafafa] border border-slate-100 hover:bg-white hover:shadow-2xl transition-all duration-500">
                ...
                <p className="font-['Poppins'] font-medium uppercase text-xs tracking-tight text-slate-800">{app}</p>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 bg-[#fafafa] border-y border-slate-100">
        <div className="max-w-screen-2xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-200 border border-slate-200 shadow-xl">
            {[
              "Trusted spare parts supplier in Tamil Nadu",
              "Competitive pricing",
      ...
      <section className="py-24 bg-white text-center border-b border-slate-50">
        <div className="max-w-screen-2xl mx-auto px-6">
          ...
          <p className="mt-10 text-slate-400 font-semibold uppercase tracking-[0.4em] text-[10px]">All Major Industrial Zones</p>
        </div>
      </section>
      ...
      <section className="py-40 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 text-center relative z-10 text-white">
          ...
          <p className="text-2xl font-['Poppins'] font-light mb-10 uppercase tracking-[0.4em] opacity-60 italic leading-snug">Looking for a reliable PSI / MDS Jack Hammer Retainer Lock Supplier?</p>
